def is_palindrom(x):
    ...
    :param x: numarul pe care il verificam daca este palindrom
...
def is_superprime(n):
    ...
    :return: bool: True daca este superprim sau False daca nu este
    '''
...
def get_largest_prime_below(n):
    run=False
    '''
    Gasim ultimul numar prim mai mic decat numarul n dat 
